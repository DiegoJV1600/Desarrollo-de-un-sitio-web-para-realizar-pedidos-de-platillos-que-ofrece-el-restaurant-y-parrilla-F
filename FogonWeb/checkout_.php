...
<head>
    ...
    <script src="https://www.paypal.com/sdk/js?client-id=AXmBoGh832SBJwcZIhJZGStHetmxkWHPBCKPgU2zJ0nFTzN1igxtzNH-WgDMwVNWze_RhUA2MAaYnfgR&currency=MXN"></script>
</head>
<body>
    <header>
        <div class="navbar navbar-expand-lg custom-navbar navbar-dark">
            <div class="container">
                <div class="logo">
                ...
                <div class="collapse navbar-collapse" id="navbarHeader">
                    ...
                    <a href="carrito.php" class="link-light custom-cart-icon">
